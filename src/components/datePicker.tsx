...
export default function DatePicker({ open, setOpen, date, setDate, month, setMonth, value, setValue }: datePickerProps) {
  return (
    <div className="relative flex gap-2">
        <Input
          ...
          className="border focus:border-black w-full rounded-md p-6 outline-none"
          onChange={(e) => {
